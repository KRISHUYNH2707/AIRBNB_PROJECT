...
import { fetchNearbyLocations } from "../../../../services/location";
...
function Places(): JSX.Element {
    ...
    const fetchLocations = async () => {
        const nearbyLocations = await fetchNearbyLocations()
    ...
    const renderNearbyLocations = () => {
        return (
            nearbyLocations.map((ele:Location, idx:number) => {
                return (
        ...
        <div className="locations">
            <div className="locations__wrapper py-lg-1 py-sm-1">
                <div className="suggested__nearbyLocation">
                    <h2 className="mb-sm-4 mt-sm-5">
                        Khám phá những địa điểm gần đây
                    </h2>
                    <div className="nearby__locations row">
