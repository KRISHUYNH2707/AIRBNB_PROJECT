                ...
                <div className="room__card-wrapper">
                    ...
                    <div className="room__desc col-md-7 d-flex flex-column justify-content-between ">
                        <div className="desc__top">
                            ...
                            <p>_____</p>
                            <p>
                                {ele.giuong} giường • {ele.phongTam} phòng tắm {ele.wifi ? '• Wifi'  : undefined} {ele.tivi ? '• Tivi'  : undefined}  {ele.bep ? '• Bếp' : undefined} 
                                {ele.dieuHoa ? '• Điều hòa nhiệt độ': undefined} {ele.mayGiat ? '• Máy giặt' : undefined} {ele.banUi  ?'• Bàn ủi' : undefined}
                                {ele.doXe  ? '• Bãi đỗ xe' : undefined} {ele.hoBoi ? '• Hồ bơi' : undefined}
                            </p>
                        </div>
                        <div className="desc__bottom d-flex">
                            <p className="ml-auto mt-auto mb-0">
                                ${ele.giaTien}<span>/ tháng</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="room__suggestion--wrapper">
                <div className="search__result col-md-8 col-xl-7">
                    <div className="brief__summary mt-md-4">
                        <p>Hơn 300 chỗ ở • {formatDate(selectedLocationState.checkinDate) + ' - ' + formatDate(selectedLocationState.checkoutDate)}</p>
